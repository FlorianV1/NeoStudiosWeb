...
return [
    'information' => [
        ...
        'tagline' => 'Level Up Your Discord Server',
        'logo' => '🚀',
    ...
    'stats' => [
        'servers' => '50,000+',  // Use comma for readability
        'users' => '2,000+', // Use comma for readability
        'uptime' => '99.99%',  // Higher uptime looks better
    ],
];
